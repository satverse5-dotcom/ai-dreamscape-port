...
"[project]/src/components/ParticlesBG.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ParticlesBG = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ParticlesBG.useEffect": ()=>{
            ...
            const handleMouse = {
                "ParticlesBG.useEffect.handleMouse": (e)=>{
                    mouseRef.current = {
                        x: e.clientX,
                        y: e.clientY
                    };
                }
            }["ParticlesBG.useEffect.handleMouse"];
            window.addEventListener("mousemove", handleMouse);
            const animate = {
                "ParticlesBG.useEffect.animate": ()=>{
                    ctx.clearRect(0, 0, canvas.width, canvas.height);
                    particles.forEach({
                        "ParticlesBG.useEffect.animate": (p, i)=>{
                            p.x += p.vx;
                            p.y += p.vy;
...
_s(ParticlesBG, "Qimi1+XRgPM/xwIviNOompZCtaA=");
_c = ParticlesBG;
const __TURBOPACK__default__export__ = ParticlesBG;
var _c;
__turbopack_context__.k.register(_c, "ParticlesBG");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
            ...
            try {
                ...
                if (data.success && data.parsedResume && data.portfolioContent) {
                    setMessages((prev)=>[
                            ...
                            {
                                role: "ai",
                                text: `I've successfully generated your portfolio content!\n\nHeadline: ${data.portfolioContent.headline}`
                            }
                        ]);
                } else {
                    setMessages((prev)=>[
...
_s(AIChat, "heXvjOT3Gqu3O8EHlrYJD/pgB+g=");
_c = AIChat;
...
//# sourceMappingURL=_31dba5fe._.js.map