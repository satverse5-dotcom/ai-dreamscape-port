...
// Validate ../../../app/api/deploy-vercel/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/deploy-vercel">> = Specific
  const handler = {} as typeof import("../../../app/api/deploy-vercel/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
